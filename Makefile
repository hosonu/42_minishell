...
# -g -fsanitize=address
SRCS = srcs/main.c srcs/lexer.c srcs/tokenize.c srcs/token_type.c srcs/sort_token.c srcs/prompt_validate.c srcs/string_utils.c srcs/debug.c srcs/free.c srcs/dispatch_token.c srcs/execve_token.c srcs/fctl_token.c srcs/manage_fd.c srcs/expand_variable.c srcs/handle_token.c
